...
exports.useCircleMarker = void 0;
...
var useCircleMarker = exports.useCircleMarker = function useCircleMarker() {
  ...
  var _useState = (0, _react.useState)(),
    ...
    circleMarker = _useState2[0],
    setCircleMarker = _useState2[1];
  (0, _react.useEffect)(function () {
    if (!AMap || !map) return;
    if (!circleMarker) {
      var instance = new AMap.CircleMarker((0, _objectSpread2["default"])({}, other));
      map.add(instance);
  ...
  (0, _reactAmapUtils.useEventProperties)(circleMarker, props, ['onHide', 'onShow', 'onMouseover', 'onTouchend', 'onClick', 'onTouchmove', 'onRightclick', 'onMouseup', 'onMouseout', 'onTouchstart', 'onMousedown', 'onDblclick']);
  return {
    circleMarker: circleMarker,
    setCircleMarker: setCircleMarker
  };
};