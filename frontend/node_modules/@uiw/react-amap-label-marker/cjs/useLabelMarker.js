...
var _excluded = ["visiable", "visible", "children", "text", "icon"];
var initIcon = {
...
var useLabelMarker = exports.useLabelMarker = function useLabelMarker() {
  ...
  (0, _react.useLayoutEffect)(function () {
    if (!labelMarker && map) {
      ...
      if ((AMap === null || AMap === void 0 || (_v = AMap.v) === null || _v === void 0 ? void 0 : _v.indexOf('1.4')) === 0) {
      ...
      return function () {
        if (instance) {
          var _v2;
          //  issue #259  兼容 v1.4.xxx 版本
          if ((AMap === null || AMap === void 0 || (_v2 = AMap.v) === null || _v2 === void 0 ? void 0 : _v2.indexOf('1.4')) === 0) {
            var _labelMarkersLayer;
            map === null || map === void 0 || (_labelMarkersLayer = map.labelMarkersLayer) === null || _labelMarkersLayer === void 0 || _labelMarkersLayer.remove(instance);
          } else {
            instance.remove();
          }
  ...
  (0, _reactAmapUtils.useVisiable)(labelMarker, visible !== null && visible !== void 0 ? visible : visiable);
  (0, _reactAmapUtils.useSettingProperties)(labelMarker, props, ['Name', 'Position', 'Zooms', 'Opacity', 'zIndex', 'Rank', 'Text', 'Icon', 'ExtData', 'Top']);
  (0, _reactAmapUtils.useEventProperties)(labelMarker, props, ['onTouchStart', 'onTouchMove', 'onTouchEnd', 'onClick', 'onMouseMove', 'onMouseOver', 'onMouseDown', 'onMouseUp', 'onMouseOut',
  // 以下事件过时兼容，将在 v6 中移除
